...
Основные данные: toDelete.User, Chat, Reminder. Это структурированные данные, один экземпляр весит очень мало (байты/килобайты).
...
Бот -> Система: Парсит команду, создает объекты toDelete.User, Chat, Reminder.
